...
$laivt_fw_conf['time_limit']=4;//Thoi gian dc thuc hien toi da $laivt_fw_conf['max_connect'] ket noi
$laivt_fw_conf['time_wait']=200;//Thoi gian cho de dc mo khoa khi IP bi khoa tam thoi
